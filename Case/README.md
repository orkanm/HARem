...
- **STLs (Standard Tessellation Language)**: Ready-to-slice files for 3D printing.
    ...
    - `HARem_Case_V1.0-Cover.stl`: The back cover.
...
### Assembly
The cover is designed to snap fit or be secured with small screws depending on your specific print tolerances. You may need to lightly sand the edges for a perfect fit.
